...
/* Sends an uninvite message to the server */
...
/* Sends an game_start message to the server */
...
socket.on('game_update',function(payload){
	...
	if('undefined' == typeof board || !board){
		console.log('Internal error: reveived a malformed board update from the server');
		return;
	}
